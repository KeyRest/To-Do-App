            ...
            <div className="w-full flex flex-col items-start  lg:p-10 p-5">
                ...
                <div className="flex items-start justify-start gap-12 flex-col w-full">
                    <div className="flex flex-col gap-2 lg:w-[50%] w-full">
                        ...
                        <input type="text" name="" id="" placeholder="Frank_ou" className="text-xl border-b-2 w-full border-black focus:ring-blue-500 focus:border-blue-500" />
                    </div>
                    <div className="flex flex-col gap-2 lg:w-[50%] w-full">
                        <h2 className="text-2xl font-semibold">PASSWORD</h2>
                        <input type="text" name="" id="" placeholder="********" className="text-xl border-b-2 w-full border-black" />

                    </div>
                    <div className="flex flex-col gap-2 lg:w-[50%] w-full">
                        <h2 className="text-2xl font-semibold">EMAIL</h2>
                        <input type="text" name="" id="" placeholder="frank_ou@test.com" className="text-xl border-b-2 w-full border-black" />
                    </div>
                </div>
