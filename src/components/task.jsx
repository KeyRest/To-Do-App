...
export default function Task({ title, date, checked, onCustomClick }) {
    ...
    return (
        <>
            <div onClick={onCustomClick} className='flex gap-8 shadow-xl transition-transform overflow-visible transform transition-colors duration-300 hover:bg-gray-200 w-full'>
                <div className='flex justify-between items-center w-full  py-2 ml-6 gap-10 '>
                    <div className='flex flex-col gap-1 '>
                        <h2 className='lg:text-2xl text-clip'>{title}</h2>
