import {
  ...
  useSlotProps
<<<<<<< HEAD
} from "./chunk-QU3BMD3R.js";
=======
} from "./chunk-DHWOJC2F.js";
import {
  useTheme
} from "./chunk-AWOFNBKN.js";
...
>>>>>>> 8f7915713db0c34ac5281f9e4551cbb9a8a32ebf
  ...
  useId
<<<<<<< HEAD
} from "./chunk-WGH7EMSQ.js";
import {
  styled_default,
  useThemeProps
} from "./chunk-I3AXOBNL.js";
=======
} from "./chunk-VMG5IZC6.js";
import {
  styled_default,
  useThemeProps
} from "./chunk-EKA7NUEH.js";
>>>>>>> 8f7915713db0c34ac5281f9e4551cbb9a8a32ebf
import {
  ...
  globalStateClasses
<<<<<<< HEAD
} from "./chunk-VOIN7EN4.js";
import {
  require_prop_types
} from "./chunk-Y7QIYIIY.js";
=======
} from "./chunk-3F2LVEY6.js";
>>>>>>> 8f7915713db0c34ac5281f9e4551cbb9a8a32ebf
import {
  require_jsx_runtime
...
var rgb_default = function rgbGamma(y2) {
  ...
  function rgb3(start3, end2) {
    var r = color2((start3 = rgb2(start3)).r, (end2 = rgb2(end2)).r), g = color2(start3.g, end2.g), b = color2(start3.b, end2.b), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t) {
      start3.r = r(t);
      start3.g = g(t);
      start3.b = b(t);
...
var InteractionContext = React9.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React9.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
...
var HighlighContext = React10.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React10.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
...
var useInteractionItemProps = (scope, skip) => {
  ...
  } = React11.useContext(HighlighContext);
  if (skip) {
    return () => ({});
  }
...
function useSvgRef() {
  const svgRef = React15.useContext(SvgContext);
  if (svgRef === void 0) {
...
function useSeries() {
  const series = React16.useContext(SeriesContext);
  if (series === void 0) {
...
var _excluded3 = ["skipAnimation", "onItemClick", "borderRadius"];
...
var useAggregatedData = () => {
  const seriesData = React18.useContext(SeriesContext).bar ?? {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
  const axisData = React18.useContext(CartesianContext);
...
true ? BarPlot.propTypes = {
   ...
   */
  borderRadius: import_prop_types2.default.number,
  /**
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React19.useRef({
    x: -1,
    y: -1
  });
  React19.useEffect(() => {
...
var _excluded4 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
var ChartChartsSurfaceStyles = styled_default("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React20.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime9.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    viewBox: `${svgView.x} ${svgView.y} ${svgView.width} ${svgView.height}`,
    ref
  }, other, {
    children: [(0, import_jsx_runtime9.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime9.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var ChartContainer = React25.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime13.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime13.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime13.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime13.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime13.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime13.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
...
var ResponsiveChartContainer = React27.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime14.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function ChartsXAxis(inProps) {
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded7);
...
function ChartsYAxis(inProps) {
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded8);
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React32.Fragment, {
...
var Portal = React33.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React33.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var ZAxisContext = React38.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React38.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React39.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const {
    xAxis,
    yAxis,
    xAxisIds,
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime25.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime25.jsx)(ChartsTooltipCell, {
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime25.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime25.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React41.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React41.useMemo(() => {
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React43.useMemo(
  ...
  const padding = React43.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React43.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React43.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = useDrawingArea();
  const series = React44.useContext(SeriesContext);
...
function ChartsOnAxisClickHandler(props) {
  ...
  const svgRef = React48.useContext(SvgContext);
  const series = React48.useContext(SeriesContext);
  const {
    axis
  ...
  return (0, import_jsx_runtime33.jsx)(React48.Fragment, {});
}
