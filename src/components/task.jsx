...
export default function Task({ title, date, checked, onCustomClick  }) {
    ...
    return (
        <>
                <div onClick={onCustomClick} className='flex gap-8 shadow-xl transition-transform overflow-visible transform transition-colors duration-300 hover:bg-gray-200'>
